...
"# 1. Enter a website to extract entities and potential relationships"
...
"# 2. Formalize triples to submit to the Golden protocol"
...
with st.container():
    ...
    st.write("Specify triple to submit for entities that already exist")
